        ...
        {            
            ...
            function createButtonDOM($button) {
                ...
                $.each($iconElem, function(key, value) {
                    if ( key === $button ) {
                        let $newElem = `<div class="WS-lb-ctrl--${$button}"><span class="${value}"></span></div>`;
                        $app.append($newElem);
                    }
                });
                if ( $button === 'arrows' ) {
                    ...
                    `<div class="WS-lb-${$button}">
                        <span class="WS-lb-arrow--left">
                            <span class="${options.arrows.icon_style}-left"></span>
                        </span> 
                        <span class="WS-lb-arrow--right">
                            <span class="${options.arrows.icon_style}-right"></span>
                        </span> 
                    </div>`;
                    $app.append($newElem);
                }
